    ...
    <tbody>
      <?php foreach ($dd as $key) { ?>
        <tr class="odd:bg-white even:bg-gray-50">
          <td class="p-3 tracking-wider text-left"><?= $key["ID"] ?></td>
          <td class="p-3 tracking-wider text-left"><?= $key["Nama Produk"] ?></td>
          <td class="p-3 tracking-wider text-left"><?= $key["Harga"] ?></td>
          <td class="p-3 tracking-wider text-left"><?= $key["Stok"] ?></td>
          <td class="p-3 tracking-wider text-center text-sm">
            <a class="py-1 px-3 border border-yellow-500 text-gray-50 shadow-md hover:opacity-70 bg-yellow-400 rounded-md" href=""><i
                class="fas fa-pencil"></i></a>
            <a class="py-1 px-3 border border-red-600 text-gray-50 shadow-md hover:opacity-70 bg-red-500 rounded-md" href=""><i
