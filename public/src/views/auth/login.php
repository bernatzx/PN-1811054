...
<body>
  ...
  <div class="h-screen flex justify-center items-center">
    <div class="max-w-md bg-gray-50 w-full shadow-lg border-2 p-5 rounded-lg">
      ...
      <form id="form-data">
        <div class="mb-4">
          ...
          <input name="email" type="text"
            class="block border w-full p-2 text-sm rounded-md border-gray-500 outline-none" placeholder="Masukkan email"
            required>
        </div>
        <div class="mb-4">
      ...
      <div class="font-semibold text-center mb-4">
        ...
        <a href="reg.php" class="text-blue-500">
          Daftar
        </a>
      </div>
  ...
  <script>
    ...
    form.addEventListener('submit', async (e) => {
      ...
      try {
        const res = await fetch("<?= base("/public/api/auth.php") ?>?route=userLN", {
          method: "POST",
